...
public class DispatchSchedule {
	 ...
	 * 
	 * @param timeSegment       defines first time at which this schedule is valid
	 *                          and length of each period
	 * @param durationInPeriods number of time periods covered by this schedule,
	 *                          i.e. multiples of timeSegment durations
	 */
	...
	/**
	 * @throws RuntimeException if given array's length is not equal to
	 *                          {@link #durationInPeriods}
	 */
	...
	/**
	 * Returns true if this schedule is defined for the given time, and if the given
	 * energy level matches the scheduled energy one
	 * 
	 * @param time                    TimeStamp which the schedule is checked for
	 * @param storageEnergyLevelInMWH current energy level in storage to be compared
	 *                                to the planned energy level at given time
	 * @return true if the schedule is applicable at the specified time and matches
	 *         the given energy in storage
	 */
	...
	/**
	 * @return true if given {@link TimeStamp} is within the time frame of this
	 *         schedule
	 */
	...
	/**
	 * @return true if given {@link TimeStamp} matches any scheduling element
	 *         beginning of this schedule exactly
	 */
	...
	/**
	 * @return true if the schedule is applicable to the specified hour with the
	 *         specified energy in storage
	 */
	...
	/**
	 * @return element number in this {@link DispatchSchedule} corresponding to the
	...
	/**
	 * Returns <b>charging power</b> for the given time as positive value - in case
	 * of discharging, 0 is returned
	 * 
	 * @param time must match schedule time element, use
	 *             {@link #isApplicable(TimeStamp, double)} to check for validity
	...
	/**
	 * Returns <b>discharging power</b> for the given time as positive value - in
	 * case of charging, 0 is returned
	 * 
	 * @param time must match schedule time element, use
	 *             {@link #isApplicable(TimeStamp, double)} to check for validity
