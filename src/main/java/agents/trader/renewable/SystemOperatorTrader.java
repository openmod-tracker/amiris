...
/** Offers energy at {@link DayAheadMarketSingleZone} of renewable power plants using a feed-in tariff support scheme
 *
...
public class SystemOperatorTrader extends AggregatorTrader {
	...
	/** Send price-independent {@link BidData bids} to {@link DayAheadMarketSingleZone} for marketing RES in FIT scheme */
	@Override
